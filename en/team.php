                ...
                <div class="col-lg-7 col-12">
                    <div class="about-right">
                        <div class="text" style="padding: 15px 32px;">
                            ...
                            <h2 style="font-size:25px;">Our closing company is 100% owned and managed by attorneys.</h2>
                            <p>
                                ...
                                experience in real estate services, which has now made us the most reliable closing
                                services! <br><br>
                                As a relationship-driven real estate closing company, Phoenix Legal Services' strength
                                lies in bringing people together to formulate a successful transaction. Our attention to
                                detail and exceptional customer service is what sets us apart. We work to exceed
                                expectations in every transaction, promising a smooth and seamless process for all
                                parties.
    ...
    <section class="info-agentes">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample"
            ...
            <div class="offcanvas-body text-center">
                ...
                <p style="color: #414141; text-align: justify;margin-top:1rem;">
                    Cesar, attorney responsible for building long-term relationships with key Phoenix clients. For the
                    past 20 years, Cesar has been involved in all aspects of the real estate industry (brokerage,
                    development, construction, trusts and escrow), both nationally and internationally. He brings a very
                    high level of organization to PLS's operation and aims to always be one step ahead of any potential
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas3Example"
            ...
            <div class="offcanvas-body text-center">
                ...
                <p style="color: #414141; text-align: justify;margin-top:1rem;">
                    ...
                    with straightforward honesty and a smart sense of humor. When she's not in the office, Karina enjoys
                    spending time with her children and friends.
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas4Example"
            ...
            <div class="offcanvas-body text-center">
                ...
                <p style="color: #414141; text-align: justify;margin-top:1rem;">
                    <a href=""></a>
                    Eduardo has a degree in psychology which has served him well in becoming an indispensable member of
                    the Phoenix Legal Services team. Although he does not act as an attorney, Eduardo is kept busy as an
                    office administrator and with all the governmental procedures required by the trusts. When the Cabo
                    heat permits, he tries not to miss the opportunity to walk his dogs or watch a sunset on the ocean.
                </p>
            </div>
        </div>
    </section>
